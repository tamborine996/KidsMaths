...
assert(html.includes('story-selection-save-btn'), 'Expected story save button in index.html');
assert(!html.includes('story-selection-clear-btn'), 'Expected Clear button to be removed from the popup');
