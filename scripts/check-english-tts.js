...
assert(app.includes('Trying ElevenLabs directly in this browser with'), 'Expected explicit ElevenLabs status');
assert(app.includes('Playing with ${this._getActiveStoryVoiceLabel()}'), 'Expected active-voice playback status');
